...
export default function NotFound() {
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center text-center px-4">
      ...
      <h1 className="font-display font-black text-4xl text-white -mt-4 mb-3">PAGE NOT FOUND</h1>
      <p className="text-kicks-gray-3 text-sm font-body mb-8">This drop doesn&apos;t exist yet.</p>
      <Link href="/"
